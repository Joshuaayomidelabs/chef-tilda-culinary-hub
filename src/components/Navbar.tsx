    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <img src={logo} alt="Chef Tilda's Culinary School" className="h-12 w-12 rounded-full object-cover ring-2 ring-gold/40" />
          <div className="hidden sm:block leading-tight">
            <div className="font-serif text-burgundy text-lg font-semibold">Chef Tilda's</div>
            <div className="text-[10px] tracking-[0.2em] text-muted-foreground uppercase">Culinary School</div>
          </div>
        </Link>
      ...
      {open && (
        <div className="lg:hidden glass-light border-t border-border mt-2">
