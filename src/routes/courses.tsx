...
export const Route = createFileRoute("/courses")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore catering, baking, pastry, mixology, Nigerian and continental cuisine, and food business courses at Chef Tilda's." },
    ...
    <>
      <section className="py-20 bg-gradient-burgundy text-primary-foreground">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="mt-6 text-primary-foreground/85">Eight specialized programs designed to transform passion into profession.</p>
        </div>
      </section>
